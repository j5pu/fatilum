...
- Name: page.spec.ts >> Navigation >> language switcher exists
- Location: e2e/page.spec.ts:74:7
...
Expected pattern: /Español|English/
Received string:  "<html><head><meta name=\"color-scheme\" content=\"light dark\"></head><body><pre style=\"word-wrap: break-word; white-space: pre-wrap;\">Internal Server Error</pre></body></html>"
```
