...
- Name: user-interactions.spec.ts >> User Interactions - Critical Flows >> no Script tag outside html error on locale switch
- Location: e2e/user-interactions.spec.ts:180:7
