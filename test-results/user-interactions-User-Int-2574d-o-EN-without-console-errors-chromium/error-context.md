...
- Name: user-interactions.spec.ts >> User Interactions - Critical Flows >> language switching ES to EN without console errors
- Location: e2e/user-interactions.spec.ts:38:7
